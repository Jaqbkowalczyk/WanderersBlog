	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				...
				.antMatchers("/css/**", "/js/**", "/h2/**"/*not suitable for production level app*/, "WEB-INF/jsps/**", 
						"/", "/**/*.png", "/**/*.jpg", "/register", "/editUserDetails", "/filtered", "/dropDownFilters", 
						"/forgottenPassword", "/terms", "/Category", "/FindCompany", "/Category/*","like/*", "/*.png", "/*.jpg","/story/*","/img/**").permitAll()
